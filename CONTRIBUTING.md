...
tests/fm-injection-scan.test.sh           # review-stage injection/honeypot symptom-catcher: flagged payloads (notice files, hidden HTML comments, zero-width unicode, base64 blobs, "ignore previous" lines) vs clean diffs and pre-existing upstream content
