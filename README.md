...
- [docs/opencode2-backend.md](docs/opencode2-backend.md) - the experimental opencode2 (oc2) HTTP-API harness adapter, reached only via `--harness opencode2`: verification proof, isolation model, and known gaps.
