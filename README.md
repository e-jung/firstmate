...
- [docs/codex-app-backend-spike.md](docs/codex-app-backend-spike.md) - evidence note and opt-in probe helper for a future `backend=codex-app`; not a registered or spawn-capable backend.
